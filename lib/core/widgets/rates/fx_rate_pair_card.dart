      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: pair.isStale
                  ? fx.warning.withValues(alpha: 0.5)
                  : fx.outlineVariant,
            ),
          ),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Flexible(child: _SourceBadge(source: pair.source)),
    ...
    return PopupMenuButton<String>(
      ...
      itemBuilder: (ctx) {
        if (pair.isDerived) {
          return [
            const PopupMenuItem(
              value: 'edit_sources',
              child: Text('Edit source PKR rates'),
            ),
        ...
        return [
          ...
          if (pair.rateId != null)
            const PopupMenuItem(
              value: 'duplicate',
              child: Text('Duplicate as new rate'),
            ),
      ...
      onSelected: (action) {
        switch (action) {
          ...
          case 'duplicate':
            if (pair.rateId != null) {
              context.push('/rates/new?from=${pair.rateId}');
            }

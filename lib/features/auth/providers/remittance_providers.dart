...
final agentRemittancesProvider = FutureProvider.family<List<FxRemittance>, String?>((ref, query) async {
  ref.watch(remittancesRefreshProvider);
  return ref.read(remittanceRepositoryProvider).fetchAgentList(query: query);
});

final agentRemittanceDetailProvider = FutureProvider.family<FxRemittance?, String>((ref, id) async {
  ref.watch(remittancesRefreshProvider);

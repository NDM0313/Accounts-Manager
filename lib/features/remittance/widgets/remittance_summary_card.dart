    ...
    return FxObsidianReportPanel(
      child: Column(
        ...
        children: [
          ...
          if (remittance.updatedAt != null)
            _meta(
              context,
              'Last updated',
              _dtFmt.format(remittance.updatedAt!.toLocal()),
            ),
          ...
          Text(
            remittance.commissionMode.label,
            style: AppTypography.bodyMd(
              context.fx.primary,
              context: context,
          ...
          if (remittance.payoutConfirmedAt != null)
            _row(
              context,
              'Payout confirmed',
              RemittanceSummaryCard._dtFmt.format(
                remittance.payoutConfirmedAt!.toLocal(),
              ),
            ),
        ],
      ),

...
abstract final class AppTypography {
  ...
  static TextStyle headlineSm(Color color, {BuildContext? context, Brightness? brightness}) => _displayStyle(
        fontSize: 18,
        fontWeight: FontWeight.w600,
        height: 24 / 18,
        color: color,
  ...
  static TextStyle dataMd(Color color, {BuildContext? context, Brightness? brightness}) => _bodyStyle(
        fontSize: 14,
        fontWeight: FontWeight.w600,
        height: 20 / 14,
        color: color,
  ...
  static TextStyle dataLg(Color color, {BuildContext? context, Brightness? brightness}) => _bodyStyle(
        fontSize: 16,
        fontWeight: FontWeight.w600,
        height: 24 / 16,
        color: color,
  ...
  static TextStyle labelCaps(Color color, {BuildContext? context, Brightness? brightness}) => GoogleFonts.inter(
        fontSize: 11,
        fontWeight: FontWeight.w700,
        letterSpacing: 0.08,
        height: 16 / 11,
  ...
  static TextStyle labelMono(Color color, {BuildContext? context, Brightness? brightness}) => GoogleFonts.jetBrainsMono(
        fontSize: 12,
  ...
  static TextTheme premiumTextTheme({required Brightness brightness}) {
    final onSurface = brightness == Brightness.light ? AppColors.lightOnSurface : AppColors.darkOnSurface;
    final muted = brightness == Brightness.light ? AppColors.lightOnSurfaceVariant : AppColors.darkOnSurfaceVariant;
    return TextTheme(
      ...
      titleSmall: GoogleFonts.manrope(fontSize: 16, fontWeight: FontWeight.w600, color: onSurface),
  ...
  static TextTheme obsidianTextTheme() => premiumTextTheme(brightness: Brightness.dark);

  @Deprecated('Use premiumTextTheme(brightness: Brightness.light)')
  static TextTheme precisionTextTheme() => premiumTextTheme(brightness: Brightness.light);
}
